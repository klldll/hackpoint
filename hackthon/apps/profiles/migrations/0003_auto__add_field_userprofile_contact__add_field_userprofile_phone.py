...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'profiles_userprofile', 'contact')

        # Deleting field 'UserProfile.phone'
        db.delete_column(u'profiles_userprofile', 'phone')
    ...
    models = {
        ...
        u'profiles.userproject': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'group'", 'unique': 'True', 'blank': 'True', 'to': u"orm['profiles.UserProfile']"}),
            'text_idea': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
